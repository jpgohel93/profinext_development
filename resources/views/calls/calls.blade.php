...
{{--                                                                <th class="min-w-75px">Exit Price</th>--}}
...
{{--                                                                <td>{{$call->target_price}}</td>--}}
                                                                ...
                                                                <td class="">
                                                                    <div class="d-flex justify-content-center">
                                                                        <div class="menu-item">
                                                                            <a href="javascript:void(0)" class="menu-link p-1 script_modal_view" data-script_name="{{$call->script_name}}">
...
{{--                                                                                </div>--}}
{{--                                                                                <div class="menu-item ">--}}
{{--                                                                                    <a href="#" class="menu-link " data-bs-toggle="modal" data-bs-target="#sqaure-off-modal">Sqaure Off</a>--}}
{{--                                                                                </div>--}}
{{--                                                                            </div>--}}
{{--                                                                        </div>--}}
                                                                    </div>
...
{{--                                                                <td>{{$call->target_price}}</td>--}}
                                                                ...
                                                                <td class="">
                                                                    <div class="d-flex justify-content-center">
                                                                        <div class="menu-item">
                                                                            <a href="javascript:void(0)" class="menu-link script_modal_view p-1" data-script_name="{{$call->script_name}}">
                                                                                <i class="fa fa-eye text-dark fa-2x"></i>
                                                                            </a>
                                                                        </div>
{{--                                                                        <div class="menu-item">--}}
