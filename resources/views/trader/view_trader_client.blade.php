                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-dark">Trader Clients</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        ...
                        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="table-responsive">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                       id="kt_table_users">
                                                @if ($dematAccount['preferred']->isNotEmpty())
                                                    <!--begin::Table head-->
                                                        <thead>
                                                        <tr
                                                        ...
                                                        @php
                                                            $i=1;
                                                        @endphp
                                                        @foreach($dematAccount['preferred'] as $account)
                                                            @php
                                ...
                                <div class="tab-pane fade show" id="renewAccount" aria-labelledby="active-tab"
                                     role="tabpanel">
                                    <!--begin::Card-->
                                    <div class="card">
                                        <!--begin::Card header-->
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="table-responsive">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                       id="kt_table_users">
                                                @if ($dematAccount['renew']->isNotEmpty())
                                                    <!--begin::Table head-->
                                                        <thead>
                                                        <tr
                                                            class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                        ...
                                                        @php
                                                            $i=1;
                                                        @endphp
                                                        @foreach($dematAccount['renew'] as $account)
                                                            @php
                                                                $datetime1 = strtotime($account->created_at);
                                                                $datetime2 = strtotime(date("Y-m-d"));
                                                                $days = (int)(($datetime2 - $datetime1)/86400);
                                ...
                                <div class="tab-pane fade show" id="problemAccount" aria-labelledby="active-tab"
                                     role="tabpanel">
                                    <!--begin::Card-->
                                    <div class="card">
                                        <!--begin::Card header-->
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="table-responsive">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                       id="kt_table_users">
                                                @if ($dematAccount['problem']->isNotEmpty())
                                                    <!--begin::Table head-->
                                                        <thead>
                                                        <tr
                                                            class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                        ...
                                                        @php
                                                            $i=1;
                                                        @endphp
                                                        @foreach($dematAccount['problem'] as $account)
                                                            @php
                                                                $datetime1 = strtotime($account->created_at);
                                                                $datetime2 = strtotime(date("Y-m-d"));
                                                                $days = (int)(($datetime2 - $datetime1)/86400);
