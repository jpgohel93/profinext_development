						...
						<div class="modal-dialog">
							<div class="modal-content rounded">
								...
								<div class="modal-body">
									<form id="add_trader_form" method="POST" action="{{route('assignTraderRoles')}}" class="form">
										@csrf
										<div class="row mb-8">
											<div class="col-md-12">
												...
												<select name="userId" required data-control="select2" class="form-select form-select-sm form-select-solid">
