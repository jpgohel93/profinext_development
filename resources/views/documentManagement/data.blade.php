                    ...
                    <div class="toolbar px-0 mx-0" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data</h1>
                                <!--end::Title-->
                                <!--begin::Separator-->
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-auto py-4 min-w-125px" data-kt-menu="true">
                                                            <div class="menu-item px-3">
                                                                <a href="{{asset('documents')."/".$document->document}}" class='menu-link px-3' target="_blank">
                                                                    View
                                                                </a>
                                                            </div>
                                                            @can("document-management-data-write")
                                                                <div class="menu-item px-3">
                                                                    <a href="javascript:void(0)" class='menu-link px-3 edit' data-id="{{$document->id}}">
                                                                        Edit
                                                                    </a>
                                                                </div>
                                                            @endcan
                                                            @can("document-management-data-delete")
                                                                <div class="menu-item px-3">
                                                                    <a href="{{route('removeDocument',$document->id)}}" class='menu-link px-3 delete'>
                                                                        Delete
                                                                    </a>
                                                                </div>
                                                            @endcan
