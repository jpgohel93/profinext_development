                ...
                <!--begin::Toolbar-->
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            @can("role-create")
                                <!--begin::Button-->
                                    <a href="{{route('createMonitorDataForm')}}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">
                                                    ...
                                                    @if ($monitorData['open']->isNotEmpty())
                                                        <!--begin::Table head-->
                                                            ...
                                                            <tr
                                                                ...
                                                                <th class="min-w-75px">Buy/Sell</th>
                                                                <th class="min-w-75px">Target</th>
                                                                <th class="min-w-75px">Entry Price</th>
                                                                <th class="min-w-75px">Entry Time</th>
                                                                <th class="min-w-75px">Exit Price</th>
                                                                <th class="min-w-75px">Exit Time</th>
                                                            ...
                                                            @foreach($monitorData['open'] as $monitor)
                                                                <tr>
                                                                    ...
                                                                    <td> {{$monitor->buy_sell}} </td>
                                                                    <td> {{$monitor->target}} </td>
                                                                    <td> {{$monitor->entry_price}} </td>
                                                                    <td> {{$monitor->entry_time}} </td>
                                                                    <td> {{$monitor->exit_price}} </td>
                                                                    <td> {{$monitor->exit_time}} </td>
                                                                    <td> {{$monitor->risk_reward}} </td>
