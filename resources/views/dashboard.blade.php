                                    ...
                                    <div class="col-xxl-8">
										...
										<div class="card card-xxl-stretch">
											...
											<div class="card-header align-items-center border-0 mt-4">
												...
												<div class="card-toolbar">
													<!--begin::Menu-->
													<a href='{{route('viewMoreLogs')}}' class="btn btn-primary btn-sm">
														More
													</a>
													<!--end::Menu-->
												</div>
                                                    ...
                                                    @forelse($activity as $data)
								                        @if ($data->description!="")
                                                            @php
                                                                ...
                                                                if(str_contains($data->description,"updated") || str_contains($data->description,"uploaded")){
                                                                    if($data->updated_at){
                                                                        $date = $data->updated_at;
                                                                    }
                                                                    $priority = "text-success";
                                                                }else if(str_contains($data->description,"deleted") || str_contains(Str::lower($data->description),"unable")){
                                                                    if($data->deleted_at){
                                                            ...
                                                            <div class="timeline-item">
                                                                <!--begin::Label-->
                                                                <div class="timeline-label fw-bolder text-gray-800 fs-6 text-nowrap" style="width:6rem">{{date("h:i A",strtotime($date))}}</div>
                                                                <!--end::Label-->
                                                                <!--begin::Badge-->
                                                                <div class="timeline-badge">
                                                                    <i class="fa fa-genderless {{$priority}} fs-1"></i>
                                                                </div>
                                                                <!--end::Badge-->
                                                                <!--begin::Content-->
                                                                <div class="timeline-content d-flex">
                                                                    <span class="fw-bolder text-gray-800 ps-3">{{$data->description}}</span>
                                                                </div>
                                                                <!--end::Content-->
                                                            </div>
                                                            <!--end::Item-->
								...
								<div class="g-5 gx-xxl-8">
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header">
											...
											<div class="card-toolbar">
												<a href="Smart trader/dist/apps/calendar.html" class="btn btn-primary">Manage Calendar</a>
											</div>
										</div>
										<!--end::Card header-->
										<!--begin::Card body-->
		...
		<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div class="card shadow-none rounded-0">
				...
				<div class="card-footer py-5 text-center" id="kt_activities_footer">
					<a href="Smart trader/dist/pages/profile/activity.html" class="btn btn-bg-body text-primary">View All Activities
					<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
