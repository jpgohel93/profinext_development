								...
								<div class="card mt-5 mt-xxl-8">
									...
									<div class="card-header card-header-stretch">
										...
										<div class="card-title d-flex align-items-center">
											...
											<!--end::Svg Icon-->
											<h3 class="fw-bolder m-0 text-gray-800">{{date('d M-Y')}}</h3>
										</div>
										<!--end::Title-->
										<!--begin::Toolbar-->
                                                        ...
                                                        @if ($data->description!="")
                                                            ...
                                                            <div class="timeline-item">
                                                                ...
                                                                @php
                                                                    ...
                                                                    if(str_contains($data->description,"updated")){
                                                                        if($data->updated_at){
                                                                            $date = $data->updated_at;
                                                                        }
                                                                    }else if(str_contains($data->description,"deleted")){
                                                                        if($data->deleted_at){
                                                                ...
                                                                <div class="timeline-content mb-10 mt-n2">
                                                                    ...
                                                                    <div class="overflow-auto pe-3">
                                                                        ...
                                                                        <div class="d-flex align-items-center mt-1 fs-6">
                                                                            <!--begin::Info-->
                                                                            <div class="text-muted me-2 fs-7">{{date('d M-Y h:i A',strtotime((string)$date))}}</div>
                                                                            <!--end::Info-->
                                                                            <!--begin::User-->
