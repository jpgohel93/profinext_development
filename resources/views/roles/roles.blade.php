																...
																<tr> 
																	...
																	<td class="text-end">
																		<div class="d-flex justify-content-end align-items-end">
																			<div class="menu-item">  
																				<a href="javascript:void(0);" data-id="{{$role->id}}" data-bs-toggle="modal" data-bs-target="#editRolesModal" class="menu-link px-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
