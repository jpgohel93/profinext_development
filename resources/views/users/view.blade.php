										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
													<a href="#" class="btn btn-lg btn-primary btn-shadow">Explore</a>
												</div>
												<!--end::Link-->
											</div>
											<!--end::Item-->
									...
									<div class="current" data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="fv-row mb-10">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-lg form-control-solid bdr-ccc" name="name" placeholder="" value="" readonly />
												<!--end::Input-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
