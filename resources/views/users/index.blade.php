										...
										<div class="w-100">
                                            ...
                                            <div class="row" id="partnerDiv" style="display:flex;">
												...
												<div class="col-md-6 mb-5">
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" class="form-control form-control-lg form-control-solid bdr-ccc" value="{{old("company")}}" name="company" placeholder=""  />
													<!--end::Input-->
												</div>
												<!--end::Input group-->
									...
									<div class="current" data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="fv-row mb-10">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-lg form-control-solid bdr-ccc" name="name" placeholder=""  />
												<!--end::Input-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
